...
const gameList = [
    ...
    '命运', '战意', "斗罗大陆", "洛克王国",
    // 网易
    "永劫无间", "漫威争锋", "鸣潮", "明日方舟", "蛋仔", "元梦", "第五人格", "如鸢",
    // 腾讯
    "界外狂潮", "新月同行", "英雄联盟", "王者荣耀",
    // "逆水寒手游", 
    "逆水寒", "DNF", "航海王壮志雄心", "龙之谷",
    ...
    // 二次元
    "崩坏星穹铁道", "绝区零", "原神",
    "少女前线", "无期迷途", "剑与远征启程", "决战平安京", "二重螺旋", "杖剑传说",
    // fps
    "萤火突击", "解限机", "守望先锋", 'CODM', "CS", "CF", "穿越火线", "和平精英", '头号追击', "远光84", "暗区",
    // 乙游，换装
    // 竞速
    // 其它
    "英雄杀",
    ...
    "银与绯",
    "物华弥新",
    "战双帕弥什", "使命召唤", "幻塔", "一梦江湖", "恋与制作人", "炉石传说", "卡拉彼丘",
    // 其它厂商
    "碧蓝航线", "碧蓝", "晴空之下", "无限暖暖", "闪耀暖暖", "奇迹暖暖", "无尽梦回", "天龙八部", "重返未来", "崩坏3", "无畏契约", "魔兽世界",
    "七日世界", "潮汐守望者", "梦幻西游",
    "异环", "异人", "影之诗", "彩虹六号",
    "FF14", "流放", "逆战", "遗忘之海", "鹅鸭杀", "旅人","代号: Lovania"
]
