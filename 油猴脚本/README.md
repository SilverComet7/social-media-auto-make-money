...
脚本文件：`note_selector.js`

功能：在抖音和小红书的搜索页 / 个人主页添加复选框，可拖拽框选，
复制选中条目的链接列表。适用于 Tampermonkey 等油猴插件。

使用步骤：
1. 将 `note_selector.js` 导入 Tampermonkey。
2. 访问抖音或小红书的搜索结果或用户主页。
3. 勾选条目或拖拽选区，然后点击右上角“复制”按钮。
4. 在弹出的提示中可复制得到的链接，粘贴至下载脚本或笔记工具使用。

脚本头部 @match 注释已经包括常见页面，可根据需要改动。
...
// @version      0.2
// @description  在抖音或小红书搜索/主页页面添加复选框，用于批量选择并复制链接
// @author       Your name
